...
def busqueda_titulo():
    ...
    if request.method == 'POST':
        ...
        resultado = fn.busca_diccionario(diccionario_titulos, titulo)
        print(titulo)
        print(resultado)
...
def busqueda_letra(letra:str):
    ''' Página de busqueda por letra '''
    resultado = fn.libro_empieza_por(lista_libros, letra)
...
def busqueda_autor():
    ...
    if request.method == 'POST':
        ...
        resultado = fn.busca_diccionario(diccionario_autores, autor)
        print(autor)
        print(resultado)
